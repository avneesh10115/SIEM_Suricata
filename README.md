...
\*\*1. Set your HOME\_NET\*\* — use your WSL subnet (replace with your actual subnet):

```yaml

HOME\_NET: "\[172.28.144.0/20]"
...
\# Triggers GPL ATTACK\_RESPONSE rule
